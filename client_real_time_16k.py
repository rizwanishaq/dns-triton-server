...
class AudioDenoiserStream:
    def __init__(self, model_name="denoiser_16Khz", triton_url="0.0.0.0:8001"):
...
if __name__ == "__main__":
    try:
        with AudioDenoiserStream(model_name="denoiser_16Khz", triton_url="0.0.0.0:8001") as audio_stream, \
            ...
            for content in audio_generator:
                ...
                try:
                    ...
                    print(
                        f'Response shape: {response.shape}, Time taken: {elapsed_time:.2f} milliseconds')
