...
INPUT_FILE_PATH = "input_audio_16.wav"
...
if __name__ == "__main__":
    try:
        ...
        with AudioDenoiserStream(model_name="denoiser_16Khz", triton_url="0.0.0.0:8001") as audio_stream, AudioPlayer(RATE) as audio_player:
